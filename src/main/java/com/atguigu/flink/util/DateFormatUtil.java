...
public class DateFormatUtil {
    ...
    private static final DateTimeFormatter dtfH = DateTimeFormatter.ofPattern("yyyy-MM-dd HH");
    ...
    /**
     * 把毫秒值转成 年月日:  2023-07-05 12
     */
    public static String tsToDateHour(Long ts) {
        Date dt = new Date(ts);
        LocalDateTime localDateTime = LocalDateTime.ofInstant(dt.toInstant(), ZoneId.systemDefault());
        return dtfH.format(localDateTime);
    }
